...
const Navbar = () => {
  ...
  useEffect(() => {
    // Correction ici: récupérer correctement la valeur de isActivated depuis localStorage
        ...
        {!scrolled && (
          <div className="top-bar">
            <div className="container">
              <a href="mailto:contact@casatech.co" className="email">
                contact@casatech.co
              </a>
              <div className="phone">
                <div className="phone-icon"></div>
                <a href="tel:+21600000000">+216 ** *** ***</a>
              </div>
            </div>
          </div>
        )}
  ...
  // Version pour utilisateur non activé
  return (
    <header className="header">
      {!scrolled && (
        <div className="top-bar">
