...
import { FaBell, FaHeart, FaCog, FaSignOutAlt, FaListAlt, FaUser, FaLock } from 'react-icons/fa';
import './Profile.css';
  ...
  return (
    ...
    <div className="profile-wrapper"style={{ marginTop: '100px' }}>
      <div className="sidebar">
        <h2>User Profile</h2>
        <ul>
          <li className="active"><FaUser /> User info</li>
          <li><FaHeart /> Favorites</li>
          <li><FaListAlt /> Watchlist</li>
          <li><FaCog /> Setting</li>
      ...
      <div className="profile-form">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <h4 className="password-section-title"><FaLock /> Change Password</h4>
