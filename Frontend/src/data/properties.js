...
const properties = [
  ...
  },
  {
    ...
    description:
      " A luxury apartment overlooking the marina, located in the heart of the prestigious tourist district of Kantaoui. ",
    features: [
